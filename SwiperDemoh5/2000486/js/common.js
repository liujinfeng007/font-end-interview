...
(function ($) {
  ...
  function dropDownFun(option) {
    ...
    $(document).on("click", $optionItem, function () {
      // 注意是获取当前元素还是子元素
      var text =
        $optionBool === false ? $(this).children().text() : $(this).text();
...
function swiper1(options, _this) {
  ...
  swiperObject[swiper] = new Swiper("#" + swiper + " .swiper-container", {
    ...
    paginationClickable:
      options.paginationClickable != undefined
        ? options.paginationClickable
        : true,
...
function swiper2(options, _this) {
  ...
  if ($(window).width() < 768) {
    $("#" + swiper)
      ...
      .css({ width: "100%" });
    slidesPerView =
      options.slidesPerViewByWap != undefined ? options.slidesPerViewByWap : 1;
    slidesPerGroup =
      options.slidesPerGroupByWap != undefined
        ? options.slidesPerGroupByWap
        : 1;
    options.tdFlow = "";
    ...
    slidesPerView = 3;
    slidesPerGroup =
      options.slidesPerGroup != undefined ? options.slidesPerGroup : 3;
  } else {
    slidesPerView =
      options.slidesPerView != undefined ? options.slidesPerView : 4;
    slidesPerGroup =
      options.slidesPerGroup != undefined ? options.slidesPerGroup : 1;
  }
  if ($("#" + swiper + " .pagination").length == 0) {
    swiperPagination = "";
  } else {
  ...
  function swiperResize(mySwiper2) {
    ...
    if (width >= 768 && width < 1200) {
      ...
      slidesPerView = 3;
      slidesPerGroup =
        mySwiper2.params.slidesPerGroup != undefined
          ? mySwiper2.params.slidesPerGroup
          : 3;
    } else if (width >= 1200) {
      // pc
      slidesPerView =
        mySwiper2.params.slidesPerView != undefined
          ? mySwiper2.params.slidesPerView
          : 4;
      slidesPerGroup =
        mySwiper2.params.slidesPerGroup != undefined
          ? mySwiper2.params.slidesPerGroup
      ...
      $("#" + swiper)
        ...
        .css({ width: "100%" });
      slidesPerView =
        mySwiper2.params.slidesPerViewByWap != undefined
          ? mySwiper2.params.slidesPerViewByWap
          : 1;
      slidesPerGroup =
        mySwiper2.params.slidesPerGroupByWap != undefined
          ? mySwiper2.params.slidesPerGroupByWap
          : 1;
  ...
  function reAside(_options, mySwiper2) {
    ...
    if (mySwiper2.params.slidesPerView == 3) {
      style_str =
        ...
        "#" +
        swiper +
        " .swiper-slide-active img { margin-left: -2.5%} " +
        "#" +
        swiper +
        " .swiper-slide-active + div img { margin-left: 1.5%} " +
        "#" +
        swiper +
        " .swiper-slide-active + div + div img { margin-left: 5.5% }" +
        "#" +
        swiper +
        " .swiper-slide-active p { margin-left: -2.5%} " +
        "#" +
        swiper +
        " .swiper-slide-active + div p { margin-left: 1.5%} " +
        "#" +
        swiper +
        " .swiper-slide-active + div + div p { margin-left: 5.5% }" +
        "</style>";
      ...
      style_str =
        ...
        "#" +
        swiper +
        " .swiper-slide-active + div img { margin-left: 0 } " +
        "#" +
        swiper +
        " .swiper-slide-active + div + div img { margin-left: 2.5% } " +
        "#" +
        swiper +
        " .swiper-slide-active + div + div + div img { margin-left: 5.5% } " +
        "#" +
        swiper +
        " .swiper-slide-active p { margin-left: -2.5%} " +
        "#" +
        swiper +
        " .swiper-slide-active + div p { margin-left: 0 } " +
        "#" +
        swiper +
        " .swiper-slide-active + div + div p { margin-left: 2.5% } " +
        "#" +
        swiper +
        " .swiper-slide-active + div + div + div p { margin-left: 5.5% } " +
        "</style>";
...
function pageReSizeToWap() {
  ...
  $(
    " body, footer, footer .foot-top, footer .foot-bottom, footer .foot-top .foot-t-cont"
  ).css({ width: "12rem" });
  $("html").css({
    "font-size": "100px",
...
function keyboardEv(obj) {
  var dName = obj.el || document,
    keyCode = obj.keyCode || 13;
 ...
 */
var resUrl = {};
var baseUrl = "http://www.cq.gov.cn/";
